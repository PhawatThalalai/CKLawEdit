        ...
        <form id='edit_cus2' enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="mb-3 input-bx" id="div_place">
                        <span>สถานที่</span>
                    ...
                    <div class="mb-3 input-bx">
                        ...
                        <select class="form-select addOPR" id="type_interest" name="type_interest" required {{@$data->type_interest != NULL ? 'readonly' : ''}}>
...
<script type="text/javascript">
    $(function() {
        ...
        $("#div_place").hide();
        $('#type_com').on('change input', () => {
            var type_com = $("#type_com").val();
            if (type_com =='ไกล่เกลี่ยชั้นบังคับคดี') {
                $("#div_place").show();
            } else {
                $("#div_place").hide();
            }
