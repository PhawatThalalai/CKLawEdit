            ...
            <div class="col-6">
                <table class="table table-sm">
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            {{ @$Compro->date_com_start != null ? formatDateThai(@$Compro->date_com_start) : '-' }}</td>
                    ...
                    @if (@$Compro->levels == 'ชั้นบังคับคดี')
                        <tr>
                            ...
                            <td class="text-end">
                                {{ @$Compro->blackout_date != null ? formatDateThai(@$Compro->blackout_date) : '-' }}
                            </td>
            ...
            <div class="col-6">
                <table class="table table-sm">
                    ...
                    <tr>
                        ...
                        <td class="text-end">{{ @$Compro->date_com != null ? formatDateThai(@$Compro->date_com) : '-' }}
                        </td>
                    ...
                    @if (@$Compro->levels == 'ชั้นบังคับคดี')
                        <tr>
                            ...
                            <td class="text-end">
                                {{ @$Compro->stop_date != null ? formatDateThai(@$Compro->stop_date) : '-' }}</td>
...
<a data-link="{{ route('LawCom.show', $Compro->cus_id) }}?type={{ 'InsertStopdate' }}" data-bs-toggle="modal"
    data-bs-target="#modal-xl" type="button" class="btn-sm  btn btn-secondary">
    <i class="fa-solid fa-money-bill-1"></i> เพิ่มวันงดการขาย
</a>

<div>
    @foreach ($stopdate as $item)
        <div class="col-12">
            <tr>
                <th class="text-start"><strong>วันงดการขายที่ {{ $loop->iteration }} : </strong></th>
                <td class="text-end">{{ formatDateThai($item->date) }} </td>
            </tr>
        </div>
    @endforeach
</div>
