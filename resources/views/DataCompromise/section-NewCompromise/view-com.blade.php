    ...
    <div class="row mb-2 g-1">
        ...
        <div class="col-4 ml-3">
            <div class="text-sm-end">
                ...
                <a type="button" id="updateAll" class="btn btn-primary btn-rounded waves-effect waves-light mb-2 me-2">
                    อัพเดตการจ่าย
                </a>
            </div>
        </div>
                                    ...
                                    @foreach ($data as $key => $item)
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                {{ Carbon\Carbon::parse(@$dataInstall->where('com_id', @$item->com_id)->where('totalSum', '!=', '0')->first()->due_date) > $today ? 0:
