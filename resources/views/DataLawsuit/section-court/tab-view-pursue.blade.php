            ...
            <div class="row">
                <div class="col-6">
                    <table class="table table-sm">
                        ...
                        <tr>
                            <th class="text-start">ยอดหนี้</th>

                                <td class="text-end">{{number_format(@$data->debt_balance) }}</td>
                ...
                <div class="col-6">
                    <table class="table table-sm">
                        <tr>
                            ...
                            <td class="text-end">{{ @$data->time_postponed != NULL ? \Carbon\Carbon::parse(@$data->time_postponed)->format('H:i') : '-' }}  </td>
                        </tr>
                        <tr>
                            <th class="text-start">สถานะ</th>
                            <td class="text-end">{{ @$data->witness_status }}</td>
